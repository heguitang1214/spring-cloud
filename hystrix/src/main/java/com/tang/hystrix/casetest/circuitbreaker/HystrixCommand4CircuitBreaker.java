        ...
        super(Setter.withGroupKey(HystrixCommandGroupKey.Factory.asKey("circuitBreakerGroupKey"))
                ...
                .andCommandPropertiesDefaults(
                        HystrixCommandProperties.Setter()
                                // 打开熔断器，达到熔断的条件：时间长度 + 请求数量 + 错误比例
                                .withCircuitBreakerEnabled(true)
                                // 窗口的时间戳：10s内至少请求10次，如果10s内没有接收到10次请求，即使所有请求都失败了，断路器也不会打开
...
//        // 当熔断后, fallback流程由main线程执行, 设置sleep, 体现【熔断恢复】现象.
        try {
    ...
    public static void main(String[] args) {
        testHystrixCommand4CircuitBreaker();
    }

    //    public static class UnitTest {
//        @Test
    private static void testHystrixCommand4CircuitBreaker() {
